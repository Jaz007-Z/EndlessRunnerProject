...
public class FireBall extends Sprite {
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setBounds(x, y, 6 / Endless.PPM, 6 / Endless.PPM);
        defineFireBall();
    }

    public void defineFireBall(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(fireRight ? getX() + 12 /Endless.PPM : getX() - 12 /Endless.PPM, getY());
        ...
        fdef.filter.categoryBits = Endless.FIREBALL_BIT;
